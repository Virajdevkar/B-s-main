...
const PaymentsPage = () => {
  const [items, setItems] = useState([
    { id: 1, name: 'Item 1', price: '$10', image: {Rasgulla}, quantity: 1 },
    { id: 2, name: 'Item 2', price: '$20', image: {Rasgulla}, quantity: 1 },
    { id: 3, name: 'Item 3', price: '$30', image: {Rasgulla}, quantity: 1 },
  ]);
            ...
            {items.map((item) => (
              ...
              <li className="item-block" key={item.id}>
                <div className="item-details">
                  <img className="item-image" src={Rasgulla} alt={item.name} />
